    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="vmTypeRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="货道数" prop="vmRow">
          <el-input-number :min="1" :max="10" v-model="form.vmRow" size="small" /> 行 &nbsp;&nbsp;&nbsp;&nbsp;
          <el-input-number :min="1" :max="10" v-model="form.vmCol" size="small" /> 列
        </el-form-item>
        <el-form-item label="货道容量" prop="channelMaxCapacity">
          <el-input-number v-model="form.channelMaxCapacity" :min="1" :max="10"/>
        </el-form-item>
